...
public class WXBizJsonMsgCrypt {
	 ...
	 */
	public WXBizJsonMsgCrypt(@Value("${wx.token}") String token,@Value("${wx.EncodingAESKey}") String encodingAesKey, @Value("${wx.corpid}") String receiveid) throws AesException {
